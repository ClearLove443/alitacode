...
workflow_path: '.alita/.alita-core/bmm/workflows/bmad-quick-flow/quick-spec'
...
- **[r]**: Execute Adversarial Review:
    1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using .alita/.alita-core/core/tasks/review-adversarial-general.xml</invoke-task>
