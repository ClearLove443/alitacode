...
workflow_path: '.alita/.alita-core/bmm/workflows/bmad-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using .alita/.alita-core/core/tasks/review-adversarial-general.xml</invoke-task>
```
