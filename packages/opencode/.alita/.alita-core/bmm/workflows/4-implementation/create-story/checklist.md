...
- The `.alita/.alita-core/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `.alita/.alita-core/core/tasks/validate-workflow.xml`
