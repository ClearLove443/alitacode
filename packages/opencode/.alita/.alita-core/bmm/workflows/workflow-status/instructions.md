...
<critical>The workflow execution engine is governed by: .alita/.alita-core/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: .alita/.alita-core/bmm/workflows/workflow-status/workflow.yaml</critical>
...
<check if="no status file found">
  ...
  <check if="response == y OR response == yes">
    ...
    <invoke-workflow path=".alita/.alita-core/bmm/workflows/workflow-status/init/workflow.yaml"></invoke-workflow>
