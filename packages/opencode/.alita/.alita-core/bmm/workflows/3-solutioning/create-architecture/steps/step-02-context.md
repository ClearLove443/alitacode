...
- Execute .alita/.alita-core/core/workflows/advanced-elicitation/workflow.xml with the current context analysis
...
- Execute .alita/.alita-core/core/workflows/party-mode/workflow.md with the current project context
