...
<critical>You MUST have already loaded and processed: .alita/.alita-core/bmm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path=".alita/.alita-core/bmm/workflows/workflow-status">
