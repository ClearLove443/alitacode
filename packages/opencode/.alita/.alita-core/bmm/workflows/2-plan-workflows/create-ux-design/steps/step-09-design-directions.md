...
- Execute .alita/.alita-core/core/workflows/advanced-elicitation/workflow.xml with the current design direction content
...
- Execute .alita/.alita-core/core/workflows/party-mode/workflow.md with the current design direction
