...
<activation critical="MANDATORY">
      ...
      <step n="4">CRITICAL: Load COMPLETE file .alita/.alita-core/bmm/data/documentation-standards.md into permanent memory and follow ALL rules within</step>
  ...
  <menu>
    ...
    <item cmd="DP or fuzzy match on document-project" workflow=".alita/.alita-core/bmm/workflows/document-project/workflow.yaml">[DP] Comprehensive project documentation (brownfield analysis, architecture scanning)</item>
    ...
    <item cmd="EF or fuzzy match on excalidraw-flowchart" workflow=".alita/.alita-core/bmm/workflows/excalidraw-diagrams/create-flowchart/workflow.yaml">[EF] Create Excalidraw flowchart for processes and logic flows</item>
    <item cmd="ED or fuzzy match on excalidraw-diagram" workflow=".alita/.alita-core/bmm/workflows/excalidraw-diagrams/create-diagram/workflow.yaml">[ED] Create Excalidraw system architecture or technical diagram</item>
    <item cmd="DF or fuzzy match on dataflow" workflow=".alita/.alita-core/bmm/workflows/excalidraw-diagrams/create-dataflow/workflow.yaml">[DF] Create Excalidraw data flow diagram</item>
