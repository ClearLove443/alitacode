...
- Agent manifest CSV is available at `.alita/.alita-core/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `.alita/.alita-core/_config/agent-manifest.csv`
