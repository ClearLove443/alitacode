...
Load config from `.alita/.alita-core/core/config.yaml` and resolve:

- `project_name`, `output_folder`, `user_name`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date` as a system-generated value
- Agent manifest path: `.alita/.alita-core/_config/agent-manifest.csv`

### Paths

- `installed_path` = `.alita/.alita-core/core/workflows/party-mode`
- `agent_manifest_path` = `.alita/.alita-core/_config/agent-manifest.csv`
